...
#Import Gudz
RUN wget https://raw.githubusercontent.com/ComradeDear/GANGSTERBOT/master/gangsterrun.py
RUN wget https://raw.githubusercontent.com/ComradeDear/GANGSTERBOT/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","gangsterrun.py"]
